...
num_of_hidden_nodes = {
    'data_sets/cancer_data.txt': [9, 1],
    'data_sets/glass_data.txt': [7, 1],
    'data_sets/iris_data.txt': [10, 11],
    'data_sets/soybean_data.txt': [18, 1],
    'data_sets/vote_data.txt': [5, 15]
}
...
for test in tests:
    ...
    for holdout_fold_idx in xrange(num_of_folds):
        ...
        model = FeedForwardNetwork(learning_rates[test], data_instances.shape[1] - 1, 2, num_of_hidden_nodes[test], num_of_outputs[test])
        # Train the model
