...
#tests=['data_sets/glass_data.txt']
#tests=['data_sets/iris_data.txt']
#tests=['data_sets/soybean_data.txt']
tests=['data_sets/vote_data.txt']
...
spreads = {
    'data_sets/cancer_data.txt': 1,
    'data_sets/glass_data.txt': 0.01,
    'data_sets/iris_data.txt': 1,
    'data_sets/soybean_data.txt': 0.1,
    'data_sets/vote_data.txt':  0.01,
}
