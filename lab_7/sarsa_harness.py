...
# Start SARSA
q_value_map = sarsa(grid_map, racetrack_height, racetrack_width, start_locs, 0.5, 0.5, 0.5, 'soft', racetrack_file)
afile = open('q_value_map.pkl', 'wb')
...
while grid_map[curr_row_pos, curr_col_pos] != 'F':
    ...
    # Choose an action using greedy method
