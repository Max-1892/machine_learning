...
bias = {
         'data_sets/encoded/cancer_data_encoded_NB_log.txt': -200.0,
         'data_sets/encoded/iris_data_encoded_normalized_1.txt': 0.0,
         'data_sets/encoded/iris_data_encoded_normalized_2.txt': 0.0,
         'data_sets/encoded/iris_data_encoded_normalized_3.txt': 20.0,
         'data_sets/encoded/soybean_data_encoded_NB_1.txt': 0.0,
         'data_sets/encoded/soybean_data_encoded_NB_2.txt': 0.0,
         'data_sets/encoded/soybean_data_encoded_NB_3.txt': 0.0,
         'data_sets/encoded/soybean_data_encoded_NB_4.txt': 20.0,
         'data_sets/encoded/vote_data_encoded_NB_log.txt': 50.0,
         'data_sets/encoded/glass_data_1_encoded.txt': 0.0,
         'data_sets/encoded/glass_data_2_encoded.txt': 0.0,
         'data_sets/encoded/glass_data_3_encoded.txt': 0.0,
         'data_sets/encoded/glass_data_4_encoded.txt': 0.0,
         'data_sets/encoded/glass_data_5_encoded.txt': 0.0,
         'data_sets/encoded/glass_data_6_encoded.txt': 0.0,
         'data_sets/encoded/glass_data_7_encoded.txt': 0.0
       }
...
learning_rates = {
    ...
    'data_sets/encoded/glass_data_1_encoded.txt': 0.2,
    'data_sets/encoded/glass_data_2_encoded.txt': 0.2,
    'data_sets/encoded/glass_data_3_encoded.txt': 0.2,
    'data_sets/encoded/glass_data_4_encoded.txt': 0.2,
    'data_sets/encoded/glass_data_5_encoded.txt': 0.2,
    'data_sets/encoded/glass_data_6_encoded.txt': 0.2,
    'data_sets/encoded/glass_data_7_encoded.txt': 0.2
}
