    ...
    def cluster(self, data):
        ...
        while len(active_clusters) > 1:
            ...
            new_cluster_centroid = \
                [np.mean((centroid_attr_1, centroid_attr_2)) for centroid_attr_1, centroid_attr_2 in zip(active_clusters[indices_of_min_distance[0]][0], active_clusters[indices_of_min_distance[1]][0])]
